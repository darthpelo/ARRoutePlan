...
//    else
        labelSize = [label.text sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:label.font, NSFontAttributeName, nil]];
...
//    else
        detailsLabelSize = [detailsLabel.text sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font, NSFontAttributeName, nil]];
